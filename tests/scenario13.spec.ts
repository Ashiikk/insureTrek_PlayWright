...
(async () => {
  ...
  // await expect(page.locator('tbody')).toMatchAriaSnapshot(`- cell "Texas active"`);
  ...
  //   - table:
  //     - rowgroup:
  //       - row /Texas expired \\d+ License Number copied to clipboard General Lines Agncy\\/Agnt \\(\\d+\\) nonActiveLoa Life, Accident, Health and HMO \\(\\d+\\) License is not active Assigned \\$ \\d+\\.\\d+ field-time file-text home Apply/:
  //         - cell "Texas expired"
  //         - cell /\\d+ License Number copied to clipboard/:
  //           - img
  //           - img
  //         - cell /General Lines Agncy\\/Agnt \\(\\d+\\) nonActiveLoa Life, Accident, Health and HMO \\(\\d+\\)/:
  //           - img "nonActiveLoa"
  //         - cell "License is not active"
  //         - cell "Assigned"
  //         - cell /\\$ \\d+\\.\\d+/
  ...
  //       - row /Texas active \\d+ License Number copied to clipboard Life Agt\\/Agy \\(\\d+\\) activeLoa Life \\(\\d+\\) Aug \\d+, \\d+ \\(\\d+ days ago\\) Assigned \\$ \\d+\\.\\d+ field-time file-text home Renew/:
  //         - cell "Texas active"
  //         - cell /\\d+ License Number copied to clipboard/:
  //           - img
  //           - img
  ...
  //   - table:
  //     - rowgroup:
  //       - row "State License No License Class & LOAs Initial Payment Renewal Payment Fee Status Graph":
  //         - columnheader "State"
  //         - columnheader "License No"
  //         - columnheader "License Class & LOAs"
  //         - columnheader "Initial Payment"
  //         - columnheader "Renewal Payment"
  //         - columnheader "Fee"
  //         - columnheader "Status Graph"
  //         - cell
  //   - table:
  //     - rowgroup:
  //       - row /Texas expired \\d+ License Number copied to clipboard General Lines Agncy\\/Agnt \\(\\d+\\) nonActiveLoa Life, Accident, Health and HMO \\(\\d+\\) Agency Agency \\$ \\d+\\.\\d+ field-time file-text home Apply/:
  //         - cell "Texas expired"
  //         - cell /\\d+ License Number copied to clipboard/:
  //           - img
  //           - img
  ...
  //   - text: Active (1) Pending (0) Missing (1)
  //   `);
  ...
  //   - table:
  //     - rowgroup:
  //       - row /Texas expired \\d+ License Number copied to clipboard General Lines Agncy\\/Agnt \\(\\d+\\) nonActiveLoa Life, Accident, Health and HMO \\(\\d+\\) License is not active Not Assigned \\$ \\d+\\.\\d+ field-time file-text home Apply/:
  //         - cell "Texas expired"
  //         - cell /\\d+ License Number copied to clipboard/:
  //           - img
  //           - img
  ...
  //   - checkbox
  //   - text: "/General Lines Agncy\\\\/Agnt \\\\(\\\\d+\\\\) \\\\( Estimated fees: \\\\$\\\\d+\\\\.\\\\d+ \\\\)/"
  //   - checkbox
  ...
  //   - paragraph: /Life \\(\\d+\\)/
  //   `);
  await page.locator('div:nth-child(2) > div > .override-checkbox-bg > span > .ant-checkbox-wrapper > .ant-checkbox > .ant-checkbox-input').uncheck();
  await page.locator('span > .ant-checkbox-wrapper > .ant-checkbox > .ant-checkbox-input').first().check();
  await page.getByRole('button', { name: 'Save Changes' }).click();
  await page.getByText('State Licenses').click();
  await page.getByRole('combobox', { name: 'Search Licenses by State,' }).click();
  ...
  //         - cell "Apply":
  //           - button "Apply" [disabled]
  //       - row /Texas active \\d+ License Number copied to clipboard Life Agt\\/Agy \\(\\d+\\) activeLoa Life \\(\\d+\\) Aug \\d+, \\d+ \\(\\d+ days ago\\) Not Assigned \\$ \\d+\\.\\d+ field-time file-text home Renew/:
  //         - cell "Texas active"
  //         - cell /\\d+ License Number copied to clipboard/:
  //           - img
  //           - img
  ...
  // await expect(page.locator('#ant-layout-container')).toMatchAriaSnapshot(`
  //   - img: AL AK AZ CO FL GA IN KS ME MA MN NJ NC ND OK PA SD TX WY CT MO WV IL NM AR CA DE DC HI IA KY MD MI MS MT NH NY OH OR TN UT VA WA WI NE SC ID NV VT LA RI
  //   - text: Active (0) Pending (0) Missing (1)
  //   `);
  // await expect(page.locator('#ant-layout-container')).toContainText('TX');
  await page.getByRole('button', { name: 'Manage' }).click();
  await page.getByRole('textbox', { name: 'Search States' }).click();
  ...
  await page.getByText('Texas').click();
  await page.locator('div').filter({ hasText: /^TXTexas$/ }).getByLabel('').uncheck();
  await page.getByRole('button', { name: 'Save Changes' }).click();
